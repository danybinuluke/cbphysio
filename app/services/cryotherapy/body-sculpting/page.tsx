...
import Banner from '@/components/services/cryotherapy/body-sculpting/Banner';
import CryoSculptingPage from '@/components/services/cryotherapy/body-sculpting/BodySculptingPage';
