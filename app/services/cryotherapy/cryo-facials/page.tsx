...
import Banner from '@/components/services/cryotherapy/cryo-facials/Banner';
import CryoFacialPage from '@/components/services/cryotherapy/cryo-facials/CryoFacialsPage';
