...
import Banner from '@/components/services/lifestyle-management/diabetes/Banner';
import DiabetesManagementPage from '@/components/services/lifestyle-management/diabetes/DiabetesPainPage';
