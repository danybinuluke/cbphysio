...
import Banner from '@/components/services/lifestyle-management/hypertension/Banner';
import HypertensionTreatmentPage from '@/components/services/lifestyle-management/hypertension/HypertensionTreatmentPage';
