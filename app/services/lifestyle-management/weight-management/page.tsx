...
import Banner from '@/components/services/lifestyle-management/weight-management/Banner';
import WeightManagementPage from '@/components/services/lifestyle-management/weight-management/WeightPainPage';
