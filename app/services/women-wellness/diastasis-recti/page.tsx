...
import Banner from '@/components/services/women-wellness/diastasis-recti/Banner';
import DiastasisRectiPage from '@/components/services/women-wellness/diastasis-recti/DiastasisRectiPage';
