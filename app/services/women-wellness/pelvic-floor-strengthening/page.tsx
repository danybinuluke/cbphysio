...
import Banner from '@/components/services/women-wellness/pelvic-floor-strengthening/Banner';
import PelvicFloorPage from '@/components/services/women-wellness/pelvic-floor-strengthening/PelvicPage';
