...
const Banner = () => {
  return (
    <section
      ...
      style={{ 
        backgroundImage: 'url("/blog-banner.jpeg")',
      ...
      <div className="absolute inset-0 bg-black/30 flex items-end pb-8 justify-start px-4 md:px-16">
        <div className="mb-2">
          ...
          <p className="text-sm md:text-base text-white/90">
            ...
            &nbsp;&gt;&nbsp;
            <Link href="/blogs" className="underline hover:text-white transition-colors">Blogs</Link>
            &nbsp;&gt;&nbsp;
            <span className="text-white">Knee Pain Treatment in Coimbatore</span>
          </p>
        </div>
      </div>
    </section>
