...
const CryoSculptingPage: React.FC = () => {
  const [activeSection, setActiveSection] = useState<string>('cs-intro');
  const [expandedSections, setExpandedSections] = useState<Record<string, boolean>>({
    'cs-intro': true,
    'how-it-works': true,
    'key-benefits': true,
    'treatment-process': true
  });
  ...
  const tableOfContents: TableOfContentsItem[] = [
    { id: 'cs-intro', title: 'Body Sculpting Overview' },
    { id: 'how-it-works', title: 'How It Works' },
    { id: 'key-benefits', title: 'Key Benefits' },
    { id: 'treatment-process', title: 'Treatment Process' }
  ];

  const benefitsList: BenefitItem[] = [
    {
      title: "Fat Reduction",
      description: "Cryotherapy selectively targets fat cells, reducing localized pockets of excess fat.",
      icon: "💪"
    },
    {
      title: "Tightened Skin",
      description: "The process stimulates collagen production, promoting skin elasticity and firmness.",
      icon: "✨"
    },
    {
      title: "Improved Metabolism",
      description: "Cryotherapy enhances metabolic rates, contributing to overall weight management.",
      icon: "⚡"
    },
    {
      title: "Cellulite Reduction",
      description: "The treatment addresses the appearance of cellulite, creating smoother skin.",
      icon: "🌟"
    }
  ];

  const treatmentSteps = [
    "Consultation: Assessment of target areas and treatment planning",
    "Preparation: Protective gel applied to treatment area",
    "Treatment: CoolSculpting applicator delivers controlled cooling",
    "Massage: Post-treatment massage to enhance results",
    "Recovery: Immediate return to normal activities",
    "Results: Gradual fat reduction over 1-3 months"
  ];
        ...
        <div className="flex-1 lg:ml-0">
          ...
          >
            <div className="absolute inset-0">
              <img 
                src="/body-sculpting-1.webp"
                alt="Cryotherapy Body Sculpting"
            ...
            >
              <h1 className="text-4xl text-blue-600 md:text-5xl font-bold mb-2">Cryotherapy Body Sculpting</h1>
              <p className="text-blue-600 text-lg">Sculpt Your Body with Cold Technology</p>
            </motion.div>
          </motion.section>
          ...
          <div className="max-w-4xl mx-auto px-6 py-8">
            ...
            >
              <div className="flex items-center mb-6">
                <h2 className="text-3xl font-bold text-gray-900">Cryotherapy Body Sculpting</h2>
                <button 
                  onClick={() => toggleSection('cs-intro')}
                  ...
                  style={{ transform: expandedSections['cs-intro'] ? 'rotate(180deg)' : 'rotate(0deg)' }}
                >
                  <ChevronDown className="w-5 h-5" />
                </button>
              </div>
              {expandedSections['cs-intro'] && (
                <motion.div 
                ...
                >
                  <p className="text-gray-700 leading-relaxed text-lg mb-4">
                    Cryotherapy Body Sculpting involves the application of controlled cold temperatures to specific areas of the body, activating a process called thermogenesis. This not only accelerates the metabolism but also triggers the breakdown of fat cells, leading to a more sculpted appearance.
                  </p>
                  <p className="text-gray-700 leading-relaxed text-lg">
                    It's a non-invasive and effective way to contour various body areas without surgery or downtime.
                  </p>
                </motion.div>
              )}
            </motion.section>
              ...
              {expandedSections['how-it-works'] && (
                ...
                >
                  <p className="text-gray-700 leading-relaxed text-lg mb-6">
                    During a Cryotherapy Body Sculpting session, the targeted area is exposed to extremely cold temperatures, causing the fat cells to crystallize and break down. This prompts the body's natural elimination processes to remove the damaged fat cells gradually.
                  </p>
                  <p className="text-gray-700 leading-relaxed text-lg">
                    The treatment is precise, ensuring that only the intended areas are sculpted, while surrounding tissues remain unharmed.
                  </p>
                </motion.div>
              )}
            </motion.section>
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <button 
                  ...
                  className="ml-auto w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white transition-transform duration-200"
                  style={{ transform: expandedSections['key-benefits'] ? 'rotate(180deg)' : 'rotate(0deg)' }}
                >
                  <ChevronDown className="w-5 h-5" />
                </button>
              </div>
              {expandedSections['key-benefits'] && (
                <motion.div 
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <button 
                  onClick={() => toggleSection('treatment-process')}
                  className="ml-auto w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center text-white transition-transform duration-200"
                  style={{ transform: expandedSections['treatment-process'] ? 'rotate(180deg)' : 'rotate(0deg)' }}
                >
                  <ChevronDown className="w-5 h-5" />
                </button>
              </div>
              {expandedSections['treatment-process'] && (
                <motion.div 
                  className="bg-white rounded-lg p-8 shadow-sm border border-gray-200"
                  variants={fadeInUp}
                  initial="hidden"
                ...
                >
                  ...
                  >
                    {treatmentSteps.map((step, idx) => (
                      <motion.li key={idx} variants={staggerItem} className="flex items-start">
                        <div className="w-8 h-8 bg-blue-500 rounded-full flex items-center justify-center text-white text-sm font-medium mr-4 flex-shrink-0">
                          {idx + 1}
                        </div>
                        <span>{step}</span>
                      </motion.li>
            ...
            >
              <div className="bg-white rounded-lg p-8 shadow-sm border border-gray-200">
                <p className="text-gray-700 text-lg mb-6">
                  Explore our full range of cryotherapy and body contouring services.
                </p>
                <motion.button 
...
export default CryoSculptingPage;
