...
const Banner = () => {
  return (
    <section
      ...
      style={{ 
        backgroundImage: 'url("/lifestyle-management.jpeg")',
        backgroundPosition: 'center 30%'
      }}
    >
      <div className="absolute inset-0 bg-black/30 flex items-end pb-8 justify-start px-4 md:px-16">
        <div className="mb-2">
          <h1 className="text-3xl md:text-4xl font-bold mb-2">Posture Correction</h1>
          <p className="text-sm md:text-base text-white/90">
            ...
            &nbsp;&gt;&nbsp;
            <Link href="/services/lifestyle-management" className="underline hover:text-white transition-colors">Lifestyle Management</Link>
            &nbsp;&gt;&nbsp;
            <span className="text-white">Posture Correction</span>
          </p>
        </div>
      </div>
    </section>
